...
% ========================================================================= 
% Input:
%        file_fmp                 : Field map file (in Hz), with a resolution of 1 mm.
% Output:
...
gam = 42.58*10^6;        % gyromagnetic ratio in Hz/T for protons
...
if diag(vx_size(1))~=abs(rot_mat(1)) % this is absolute not the actual value!
...
fm_dX = fm_dX/vx_size(1)/gam;
fm_dY = fm_dY/vx_size(2)/gam;
fm_dZ = fm_dZ/vx_size(3)/gam;
